...
def before_feature(context, feature):
    configs = ConfigReader("/Users/anastasiatskhay/PycharmProjects/PythonIntro/BrainBucketTesting/BDDBehave/registration_errors/steps/config.ini")
